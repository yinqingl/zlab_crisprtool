...
RD_DATAROOT = "/data/ramdisk/crispr" # genomes_settings.get("byte_libraries_root")
RD_GENOMESROOT = "/data/ramdisk/genomes" # genomes_settings.get("gfport_root")
...
def create_locs_file(genome):
    ...
    twobitfile = os.path.join(RD_GENOMESROOT, "{0}.2bit".format(genome))
...
def create_packed_locs_file(genome):
    ...
    bytepack_file_template = os.path.join(RD_DATAROOT,"{0}_loci_bytes.dat")
